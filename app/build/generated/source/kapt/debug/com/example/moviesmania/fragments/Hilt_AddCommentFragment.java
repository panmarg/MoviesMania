 ...
 */
public abstract class Hilt_AddCommentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddCommentFragment() {
    super();
  }

  Hilt_AddCommentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCommentFragment_GeneratedInjector) this.generatedComponent()).injectAddCommentFragment(UnsafeCasts.<AddCommentFragment>unsafeCast(this));
    }
  }
