 ...
 */
public abstract class Hilt_UserCommentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserCommentsFragment() {
    super();
  }

  Hilt_UserCommentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserCommentsFragment_GeneratedInjector) this.generatedComponent()).injectUserCommentsFragment(UnsafeCasts.<UserCommentsFragment>unsafeCast(this));
    }
  }
